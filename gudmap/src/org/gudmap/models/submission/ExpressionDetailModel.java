...
public class ExpressionDetailModel {
	    ...
	    private ExpressionPatternModel[] expressionPatternModel;
	    ...
	    public ExpressionPatternModel[] getPattern() {
	        return expressionPatternModel;
	    }

	    public void setPattern(ExpressionPatternModel[] expressionPatternModel) {
	        this.expressionPatternModel = expressionPatternModel;
	    }
