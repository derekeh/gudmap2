...
public class IshSubmissionAssembler {
	...
	public IshSubmissionModel getData(String oid, /*boolean isEditor, */
		...
		ishSubmissionModel.setStageDisplay(submissionModel.getStageDisplay());
		ishSubmissionModel.setStagePrefix(submissionModel.getStagePrefix());
		...
		ishSubmissionModel.setSourceLab(submissionModel.getSourceLab());
		//This is for the old tree. Don't need anymore
