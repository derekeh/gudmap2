...
/*
 * This assembler is invoked by InsituTableBean.java. It takes in and processes the whole model. EG. All the subsequent work is done  client side on the model with no return to the DB server.
