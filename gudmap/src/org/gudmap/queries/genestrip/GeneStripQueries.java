...
public class GeneStripQueries {
	...
	final static public Hashtable<String, String[]>  getRefTableAndColTofindGeneSymbols() {
	  ...
	  public static String INSITU_SUBMISSION_IMAGES_BY_IMAGE_ID = "SELECT SUB_ACCESSION_ID, SUB_EMBRYO_STG, SPN_ASSAY_TYPE, CONCAT(I.URL_URL, IMG_FILEPATH, 'medium/',IMG_FILENAME), CONCAT(C.URL_URL, IMG_CLICK_FILEPATH, IMG_CLICK_FILENAME), CONCAT(SUB_OID,'_',IMG_FILENAME) " +
				"FROM ISH_SUBMISSION " +
