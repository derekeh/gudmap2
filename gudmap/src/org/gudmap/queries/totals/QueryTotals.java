...
public class QueryTotals {
	...
	/*private final String ASSAY_TYPE_TOTAL_GUDMAP_ACCESSION="SELECT COUNT(DISTINCT SUB_ACCESSION_ID) AS TOTAL FROM ISH_SUBMISSION JOIN ISH_PERSON ON SUB_PI_FK = PER_OID " +
										...
										"WHERE SUB_ASSAY_TYPE = ? AND "+GenericQueries.PUBLIC_ENTRIES+" %s";*/
	private final String ASSAY_TYPE_TOTAL_GUDMAP_ACCESSION="SELECT COUNT(DISTINCT SUB_ACCESSION_ID) AS TOTAL "+GenericQueries.INSITU_TOTAL_JOINS+GenericQueries.PUBLIC_ENTRIES+" %s";
	
	private final String ASSAY_TYPE_TOTAL_GENE_KEY="ASSAY_TYPE_TOTAL_GENE";
	private final String ASSAY_TYPE_TOTAL_GENE="SELECT COUNT(DISTINCT RPR_SYMBOL) AS TOTAL "+GenericQueries.INSITU_TOTAL_JOINS+GenericQueries.PUBLIC_ENTRIES+" %s";
	
	private final String ASSAY_TYPE_TOTAL_SOURCE_KEY="ASSAY_TYPE_TOTAL_SOURCE";
	private final String ASSAY_TYPE_TOTAL_SOURCE="SELECT COUNT(DISTINCT PER_SURNAME) AS TOTAL  "+GenericQueries.INSITU_TOTAL_JOINS+GenericQueries.PUBLIC_ENTRIES+" %s";
	
	private final String ASSAY_TYPE_TOTAL_SUBMISSION_DATE_KEY="ASSAY_TYPE_TOTAL_SUBMISSION_DATE";
	private final String ASSAY_TYPE_TOTAL_SUBMISSION_DATE="SELECT COUNT(DISTINCT SUB_SUB_DATE) AS TOTAL  "+GenericQueries.INSITU_TOTAL_JOINS+GenericQueries.PUBLIC_ENTRIES+" %s";
	
	private final String ASSAY_TYPE_TOTAL_ASSAY_TYPE_KEY="ASSAY_TYPE_TOTAL_ASSAY_TYPE";
	private final String ASSAY_TYPE_TOTAL_ASSAY_TYPE="SELECT COUNT(DISTINCT SUB_ASSAY_TYPE) AS TOTAL  "+GenericQueries.INSITU_TOTAL_JOINS+GenericQueries.PUBLIC_ENTRIES+" %s";
	
	private final String ASSAY_TYPE_TOTAL_PROBE_NAME_KEY="ASSAY_TYPE_TOTAL_PROBE_NAME";
	private final String ASSAY_TYPE_TOTAL_PROBE_NAME="SELECT COUNT(DISTINCT RPR_JAX_ACC) AS TOTAL  "+GenericQueries.INSITU_TOTAL_JOINS+GenericQueries.PUBLIC_ENTRIES+" %s";
	
	private final String ASSAY_TYPE_TOTAL_EMBRYO_STAGE_KEY="ASSAY_TYPE_TOTAL_EMBRYO_STAGE";
	private final String ASSAY_TYPE_TOTAL_EMBRYO_STAGE="SELECT COUNT(DISTINCT SUB_EMBRYO_STG) AS TOTAL  "+GenericQueries.INSITU_TOTAL_JOINS+GenericQueries.PUBLIC_ENTRIES+" %s";
	...
	private final String ASSAY_TYPE_TOTAL_AGE="SELECT COUNT(DISTINCT TRIM(CASE SPN_STAGE_FORMAT WHEN 'dpc' THEN CONCAT(SPN_STAGE,' ',SPN_STAGE_FORMAT) WHEN 'P' THEN CONCAT('P',SPN_STAGE) ELSE " +
										"CONCAT(SPN_STAGE_FORMAT,SPN_STAGE) END))  AS TOTAL  "+GenericQueries.INSITU_TOTAL_JOINS+GenericQueries.PUBLIC_ENTRIES+" %s";
	
	private final String ASSAY_TYPE_TOTAL_SEX_KEY="ASSAY_TYPE_TOTAL_SEX";
	private final String ASSAY_TYPE_TOTAL_SEX="SELECT COUNT(DISTINCT SPN_SEX) AS TOTAL  "+GenericQueries.INSITU_TOTAL_JOINS+GenericQueries.PUBLIC_ENTRIES+" %s";
	
	private final String ASSAY_TYPE_TOTAL_GENOTYPE_KEY="ASSAY_TYPE_TOTAL_GENOTYPE";
	private final String ASSAY_TYPE_TOTAL_GENOTYPE="SELECT COUNT(DISTINCT SPN_WILDTYPE) AS TOTAL  "+GenericQueries.INSITU_TOTAL_JOINS+GenericQueries.PUBLIC_ENTRIES+" %s";
	...
	private final String ASSAY_TYPE_TOTAL_SPECIMEN_TYPE="SELECT COUNT(DISTINCT SPN_ASSAY_TYPE) AS TOTAL  "+GenericQueries.INSITU_TOTAL_JOINS+GenericQueries.PUBLIC_ENTRIES+" %s";
	
	private final String ASSAY_TYPE_TOTAL_IMAGES_KEY="ASSAY_TYPE_TOTAL_IMAGES";
	private final String ASSAY_TYPE_TOTAL_IMAGES="SELECT COUNT(IMG_OID) AS TOTAL FROM ISH_SUBMISSION JOIN ISH_PERSON ON SUB_PI_FK = PER_OID " +
										"JOIN ISH_SPECIMEN ON SPN_SUBMISSION_FK = SUB_OID JOIN ISH_PROBE ON PRB_SUBMISSION_FK = SUB_OID LEFT JOIN REF_PROBE ON RPR_OID = PRB_MAPROBE " +
										"JOIN ISH_ORIGINAL_IMAGE ON SUB_OID = IMG_SUBMISSION_FK " +
										"WHERE IMG_TYPE NOT LIKE '%%wlz%%' AND SUB_ASSAY_TYPE = ? AND "+GenericQueries.PUBLIC_ENTRIES+" %s";
