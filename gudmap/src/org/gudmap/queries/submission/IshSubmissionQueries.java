...
public static String STAGE_FORMAT_CONCAT = bundle.getString("project").equals("GUDMAP") ? 
	...
	public static String SUBMISSION_BY_OID = "SELECT SUB_ACCESSION_ID, IF(STG_SPECIES='Mus musculus',SUBSTR(STG_STAGE_DISPLAY,3),STG_STAGE_DISPLAY) as Stage, SUB_ASSAY_TYPE, " +
			...
			"SUB_NAMESPACE, SUB_OS_ACCESSION, SUB_LOCAL_ID, SUB_SOURCE, SUB_VALIDATION, " +
			"SUB_CONTROL, SUB_ASSESSMENT, SUB_CONFIDENCE, SUB_LOCALDB_NAME, " +
			"SUB_LAB_ID, SUB_ACCESSION_ID_2, SUB_OID, STG_ANATOMY, STG_SPECIES, STG_STAGE_DISPLAY, STG_PREFIX FROM ISH_SUBMISSION " + 
			"LEFT JOIN REF_STAGE ON SUB_STAGE_FK = STG_OID " +
			"WHERE SUB_OID = ?";
	
	//UNUSED. EXTENSION OF ABOVE TO INCLUDE ANATOMY. USE SEQUENCE_QUERIES::SEQUENCE_SAMPLE_ANATOMY INSTEAD
	public static String SEQ_SUBMISSION_BY_OID = "SELECT SUB_ACCESSION_ID, IF(STG_SPECIES='Mus musculus',SUBSTR(STG_STAGE_DISPLAY,3),STG_STAGE_DISPLAY) as Stage, SUB_ASSAY_TYPE, " +
		"SUB_MODIFIED_DATE, SUB_MODIFIED_BY, SUB_VERSION_NO, SUB_IS_PUBLIC, SUB_ARCHIVE_ID, " +
		"SUB_IS_DELETED, SUB_SUBMITTER_FK, SUB_PI_FK, SUB_ENTRY_BY_FK, SUB_MODIFIER_FK, " +
		"SUB_DB_STATUS_FK, SUB_PROJECT_FK, SUB_BATCH, " +
		"SUB_NAMESPACE, SUB_OS_ACCESSION, SUB_LOCAL_ID, " +
		"SUB_SOURCE, SUB_VALIDATION, " +
		"SUB_CONTROL, SUB_ASSESSMENT, SUB_CONFIDENCE, SUB_LOCALDB_NAME, " +
		"SUB_LAB_ID, SUB_ACCESSION_ID_2, SUB_OID, STG_ANATOMY, " +
		"GROUP_CONCAT(DISTINCT CONCAT(ANO_COMPONENT_NAME, ' (' , ATN_PUBLIC_ID, ')') SEPARATOR ', ') components, FROM ISH_SUBMISSION " + 
		"LEFT JOIN REF_STAGE ON SUB_STAGE_FK = STG_OID " +
		"JOIN ANA_TIMED_NODE ON ATN_PUBLIC_ID=IST_COMPONENT JOIN ANA_NODE ON ATN_NODE_FK = ANO_OID " +
