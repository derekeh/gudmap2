...
public class SolrQueries {
	...
	public final static String GET_EUREXPRESS_INDEX_DATA = "SELECT * FROM SOLR_EEDATA";	
	public final static String GET_EUREXPRESS_IMAGE_INDEX_DATA = "SELECT * FROM SOLR_EEIMAGES";	
	public final static String GET_EMAGE_INDEX_DATA = "SELECT * FROM SOLR_EMAGE_DATA";		
