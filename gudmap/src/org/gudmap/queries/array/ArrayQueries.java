...
public class ArrayQueries {
	...
	public static String SAMPLE_ANATOMY = "SELECT CONCAT(ANO_COMPONENT_NAME, ' (' , ATN_PUBLIC_ID, ') ') from ISH_SUBMISSION "+
	 ...
	 public static String ARRAY_IMAGES = "SELECT SUB_ACCESSION_ID gudmap_accession, CONCAT(I.URL_URL, IMG_FILEPATH, IMG_FILENAME) filepath, CONCAT(C.URL_URL, IMG_CLICK_FILEPATH, " +
			 ...
			 "IMG_IS_PUBLIC = 1 AND IMG_TYPE NOT LIKE '%wlz%' AND SUB_DB_STATUS_FK = 4 AND SUB_ASSAY_TYPE='Microarray' ORDER BY IMG_ORDER ";
