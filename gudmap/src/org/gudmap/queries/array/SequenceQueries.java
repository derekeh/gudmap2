...
public class SequenceQueries {
	...
	public final static String SEQUENCE_NUM_SAMPLES = "SELECT COUNT(NGL_SAMPLE_FK) " +
	...
	public final static String SEQUENCE_IMAGES = "SELECT SUB_ACCESSION_ID gudmap_accession, CONCAT(I.URL_URL, IMG_FILEPATH, IMG_FILENAME) filepath, CONCAT(C.URL_URL, IMG_CLICK_FILEPATH, " +
			 ...
			 "IMG_IS_PUBLIC = 1 AND IMG_TYPE NOT LIKE '%wlz%' AND SUB_DB_STATUS_FK = 4 AND SUB_ASSAY_TYPE='NextGen' ORDER BY IMG_ORDER ";
