...
public static String PROBESET_FROM_SYMBOL_AND_PLATFORM_ID = "SELECT DISTINCT PRS_PROBE_SET_ID FROM MIC_PROBE_SET JOIN MIC_PROBE_SET_GENE ON PSG_PROBE_SET_FK = PRS_OID JOIN REF_GENE_INFO ON PSG_GENE_INFO_FK = GNF_OID WHERE GNF_SYMBOL = ? AND PRS_PLATFORM_ID = ?";
...
public static String NALYSIS_GENELIST_CLUSTER_TITLE = "SELECT AGC_TITLE FROM MIC_ANAL_GENELIST_COLUMN WHERE AGC_OID = ? ";
