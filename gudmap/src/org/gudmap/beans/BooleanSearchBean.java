...
import org.gudmap.assemblers.AnatomyStructureAssembler;
import org.gudmap.globals.Globals;
import org.gudmap.models.parser.BooleanQueryParserDelegate;
import org.gudmap.utils.FileHandler;
import org.gudmap.utils.Utils;

@Named
@RequestScoped
public class BooleanSearchBean {
    ...
    public SelectItem [] getAnnotationVals() {
        ...
        if(Utils.getProject().equals("GUDMAP")){
    ...
    public SelectItem [] getResultFormat() {
        return new SelectItem []
        { new SelectItem(Utils.getProject(),Utils.getProject()+" entries"),
...
//		System.out.println("validation message:"+message);
    	...
    	Globals.setSessionValue("input", input);
    	/*return "queryresult";*/
    	return "browseBooleanResult";
    }
