...
/**
 * <h1>BiomedAtlasGeneStripBean</h1>
 * The BiomedAtlasStripBean class contains the methods to provide data and deal with events on the
 * biomedAtlasGeneStrip.xhtml web page
 * 
 * @author Bernard Haggarty
 * @version 1.0
 * @since 13/03/2013 
 */
@Named (value="biomedAtlasGeneStripBean")
@SessionScoped
public class BiomedAtlasGeneStripBean extends PagerImpl implements Serializable  {
...
//    private MicroarrayHeatmapBeanAssembler microarrayHeatmapBeanAssembler;
    ...
    public BiomedAtlasGeneStripBean() {
...
//        tableinfo = microarrayHeatmapBeanAssembler.getMasterTableList();
    ...
    public void loadDataList() {
        ...
        totalRows = solrTreeBean.getSolrUtil().getBiomedAtlasGeneCount(solrInput, filters);
...
//	   	}     	
    ...
    public String refresh(){
    	loadDataList();
    	return "biomedAtlasGeneStripBean";
    }
...
//	} 
	...
	public List<GeneStripModel> getData(String solrInput, HashMap<String,String> filterlist, String sortColumn, boolean ascending, int offset, int num){
    	...
    	SolrDocumentList sdl  = solrTreeBean.getSolrUtil().getBiomedAtlasGudmapGenes(solrInput, filterlist, sortColumn,ascending,offset,num);
		if (sdl==null){
			return null;
		}
		...
		totals = (HashMap<String, String>) solrTreeBean.getSolrUtil().getBiomedAtlasGeneDataCount(solrInput, filterlist);
...
//				insituExpression = "not detected";
			...
			if (doc.containsKey("SOURCE")){
				...
				if (!source.equals("gudmap")) 
					model.setImageUrl(doc.getFieldValue("IMAGE_PATH").toString());
			}
