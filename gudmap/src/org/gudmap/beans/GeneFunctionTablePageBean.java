...
@Named
@SessionScoped
public class GeneFunctionTablePageBean extends PagerImpl implements Serializable  {
	
	private static final long serialVersionUID = 1L;

    // Data.
	protected GeneFunctionTablePageBeanAssembler assembler;
    ...
    public GeneFunctionTablePageBean() {
    	super(20,10,"x.assay_type",true);   	
        //setup("ISH","");
        setup();
    }
    
	public GeneFunctionTablePageBean(int rowsperpage, int pagenumbers, String defaultOrder, boolean sortDirection) {
