...
import org.gudmap.beans.assemblers.InsituPagingBeanAssembler;
import org.gudmap.models.InsituTableBeanModel;

@Named
@SessionScoped
public class InsituPagingBean implements Serializable {
	
	 private static final long serialVersionUID = 1L;

    // Data.
	private InsituPagingBeanAssembler assembler;
    ...
    public InsituPagingBean() {
        // Set default values somehow (properties files?).
        rowsPerPage = 20; // Default rows per page (max amount of rows to be displayed at once).
        pageRange = 10; // Default page range (max amount of page links to be displayed at once).
        sortField = "SUB_OID"; // Default sort field.
        sortAscending = true; // Default sort direction.
        assembler=new InsituPagingBeanAssembler();
