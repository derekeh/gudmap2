...
STG_SPECIES AS SPECIES 
FROM ISH_SUBMISSION LEFT JOIN ISH_PROBE ON SUB_OID=PRB_SUBMISSION_FK LEFT JOIN REF_PROBE ON PRB_MAPROBE=RPR_OID 
left join REF_STAGE on SUB_STAGE_FK=STG_OID
...
ALTER TABLE SOLR_GENES_INDEX ADD COLUMN SYNONYMS varchar (250);
...
UIG_TITLE,UIG_DESC,UGP_TITLE,UGP_DESCRIPTION
